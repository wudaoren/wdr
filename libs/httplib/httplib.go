...
var defaultSetting = BeegoHttpSettings{false, "beegoServer", 60 * time.Second, 60 * time.Second, nil, nil, nil}
...
func (b *BeegoHttpRequest) UseCookieJar(jar *cookiejar.Jar) *BeegoHttpRequest {
	if jar == nil {
...
func (b *BeegoHttpRequest) SetCookie(cookie *http.Cookie) *BeegoHttpRequest {
	b.cookieStr += cookie.Name + "=" + cookie.Value + ";"
	b.req.Header.Set("Cookie", b.cookieStr)
	return b
}
